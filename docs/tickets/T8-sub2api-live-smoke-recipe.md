...
`models use` ids must already exist in `models`. For a grokbox-test0-only canary (T10), assign luna with `--for 00000000-0000-4000-8000-000000000114` and leave `main` unset so grokbox test1 and other bots stay official.
