...
| [T45](T45-template-webhook-delivery.md) | Partial：同库outbox、显式HTTPS和授权后的daemon自动发送已实现；真实报告、collector/boot安装仍待验 | OBS-02/03、T43/T51/T54；unknown不重发；最新组合及未完成测试见2026-09-19回执 |
