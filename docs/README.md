...
- [T32 live-enable readiness](maintainers/t32-live-enable-readiness.md): default-off still fail-closed; owner unlocked GATE-on + live overflow dogfood (evening 2026-09-11); structured overflow surface still open: offline checklist; HostCompact default-off; live overflow dogfood deferred (not a tip gate).
