...
Current implementation evidence and planned-case status remain in [tickets](tickets/README.md) and [readiness](maintainers/t32-live-enable-readiness.md); this section does not declare the new gates implemented.
