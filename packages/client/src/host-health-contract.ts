import {projectHostHealth,projectHostRuntimeObservation,type HostRuntimeObservation,type HostHealthEvidence} from "@grokbox/runtime-kernel/host-health";
...
export function hostHealthView(value:unknown,installationId:string):value is HostHealthView{
  ...
  const keys=["component","owner","state","reason","observedAtMs","lastAttemptAtMs","assessment","latest","intake","runtime","runtimeIntake","watch","analyses","qualified","executionAuthority"];
