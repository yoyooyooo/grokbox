...
test("shared client bundles for the browser without Node, Effect, storage or provider imports", async () => {
  ...
  const inputs = Object.keys(built.metafile!.inputs).map(path => {
    const marker = "node_modules/@noble/hashes/";
    const offset = path.lastIndexOf(marker);
    return offset < 0 ? path : `@noble/hashes/${path.slice(offset + marker.length)}`;
  });
  expect(inputs.sort()).toEqual(["packages/client/src/system-integration-contract.ts", "packages/client/src/model-probe-contract.ts", "packages/runtime-kernel/src/model-probe.ts", "packages/runtime-kernel/src/model-management-error.ts", "packages/client/src/access-contract.ts", "packages/client/src/model-credential-contract.ts", "packages/client/src/system-config-contract.ts", "packages/client/src/client.ts", "packages/client/src/compaction-contract.ts", "packages/client/src/context-contract.ts", "packages/client/src/context-validation.ts", "packages/client/src/contract.ts", "packages/client/src/desktop-validation.ts", "packages/client/src/event-watch.ts", "packages/client/src/file-validation.ts", "packages/client/src/handover-contract.ts", "packages/client/src/host-health-contract.ts", "packages/client/src/incident-contract.ts", "packages/client/src/incident-validation.ts", "packages/client/src/job-contract.ts", "packages/client/src/job-validation.ts", "packages/client/src/lifecycle-contract.ts", "packages/client/src/lifecycle-validation.ts", "packages/client/src/material-validation.ts", "packages/client/src/message-contract.ts", "packages/client/src/notification-send-contract.ts", "packages/client/src/notification-send-validation.ts", "packages/client/src/notification-validation.ts", "packages/client/src/observation-validation.ts", "packages/client/src/protection-contract.ts", "packages/client/src/protection-validation.ts", "packages/client/src/receiver-contract.ts", "packages/client/src/receiver-validation.ts", "packages/client/src/response-validation.ts", "packages/client/src/setup-contract.ts", "packages/client/src/setup-validation.ts", "packages/runtime-kernel/src/compaction.ts", "packages/runtime-kernel/src/desktop.ts", "packages/runtime-kernel/src/files.ts", "packages/runtime-kernel/src/host-compilation.ts", "packages/runtime-kernel/src/host-health.ts", "packages/runtime-kernel/src/host-source-evolution.ts", "packages/runtime-kernel/src/host-witness.ts", "packages/runtime-kernel/src/materials.ts", "packages/client/src/product-contract.ts", "packages/runtime-kernel/src/canonical-json.ts", "packages/runtime-kernel/src/portable-hash.ts", "packages/runtime-kernel/src/products.ts", "packages/runtime-kernel/src/internal/continuity/native-product.ts", "packages/runtime-kernel/src/internal/continuity/primitives.ts", "packages/runtime-kernel/src/internal/contract/errors.ts", "packages/runtime-kernel/src/internal/contract/title-marker.ts", "packages/runtime-kernel/src/internal/selection/reasoning.ts", "@noble/hashes/_md.js", "@noble/hashes/_u64.js", "@noble/hashes/sha2.js", "@noble/hashes/utils.js"].sort());
