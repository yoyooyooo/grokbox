...
export async function runRuntimeMonitor(deps: CliDeps, action: "init"|"run"|"snapshot"|"events"|"incidents"|"ack"|"snooze"|"incident"|"capture"|"lease"|"storage-status", args: Array<string | undefined>, raw: Options): Promise<void> {
  try {
