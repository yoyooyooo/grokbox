  ...
  return Effect.gen(function* () {
    ...
    yield* Effect.gen(function* () {
      const listener = yield* serveModeld({
        ...
        observeStep: (request, outcome) => writeModeldStepOutcome(options.runRoot, request, outcome, options.durableRoot),
        observeRecovery: (request, recovery) => writeModeldRecoveryProgress(options.runRoot, request, recovery, options.durableRoot),
        observeAuthority: (request, authority, observedAt) => writeModeldAuthorityProgress(options.runRoot, request, authority, observedAt, options.durableRoot),
