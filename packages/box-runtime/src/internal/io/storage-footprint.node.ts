...
/** Metadata only within three explicit diagnostic namespaces. Counts backups,
 * staging and auxiliary files even when a DB reader fails. No file contents or
 * filenames exported, no symlink following, and no deletion authorization. */
