...
export const LIVE_SLICE_PATCHES: readonly SlicePatch[] = [
  ...
  },
  {
    ...
    replacement: `        } catch (error42) {\n          const __grokbox_failed = globalThis[Symbol.for("${HOST_MANAGED_FAILURE_SYMBOL}")];\n          if (typeof __grokbox_failed === "function" && __grokbox_failed(error42)) throw error42;\n          if (error42 instanceof OutputTokensLimitExceededError) {`,
  },
  {
