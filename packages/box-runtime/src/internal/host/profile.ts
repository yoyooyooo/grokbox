...
export const OBSERVATION_SLICE_IDS = ["tool-execution-observation", "tool-execution-failure-observation", "receiver-native-model-preview", "server-activity-live-observation", "server-activity-expiry-observation", "run-queue-observation", "group-member-observation", "group-buffer-observation", "alert-manager-observation", "alert-main-decision", "alert-input-cleanup", "alert-automation-decision", "alert-automation-throttle"] as const;
