...
/** Current source-backed interop anchors. Observe native policy and mutation;
...
export const ALERT_OBSERVATION_SLICES: readonly SlicePatch[] = [
  ...
  { id:"alert-automation-decision",startAnchor:"  notifyAutomationFailure(session, automation, trigger2, description9) {", endAnchor:"  clearAutomationFailureState(agentId, automationId) {",
  ...
  { id:"alert-automation-throttle",startAnchor:"  notifyAutomationFailure(session, automation, trigger2, description9) {", endAnchor:"  clearAutomationFailureState(agentId, automationId) {",
