...
export const ALERT_OBSERVATION_SLICES: readonly SlicePatch[] = [
  ...
  { id:"alert-automation-decision",startAnchor:"  notifyAutomationFailure(session, automation, trigger2, description7) {",endAnchor:"  clearAutomationFailureState(agentId, automationId) {",
  ...
  { id:"alert-automation-throttle",startAnchor:"  notifyAutomationFailure(session, automation, trigger2, description7) {",endAnchor:"  clearAutomationFailureState(agentId, automationId) {",
