...
| `inference-oracles.json` | `modeld*.test.ts`, seam/stub-route/t11/turn-seam | Keep selective route / duplicate / conflict / visible managed failure. Drop complete-array, v2 server, StubRouteDriver, EOF-success | T23–T26 |
