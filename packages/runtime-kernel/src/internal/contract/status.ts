...
export const JOURNAL_EVENT_ALLOWLIST = {
  host: ["host_stream_rejected", "host_normalized_terminal", "turn_seam_terminal", "host_seam_stage", "host_run_observation", "host_alert_observation", "host_server_activity_observation", "host_context_observation", "host_tool_observation"],
  modeld: ["model_step_terminal", "provider_error_observed", "model_recovery_progress", "model_authority_progress"],
  control: [
    "disk_sha_observed",
    "contracts_snapshot",
