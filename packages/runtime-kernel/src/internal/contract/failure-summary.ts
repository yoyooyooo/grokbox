...
export const PROVIDER_ERROR_PARAMS = ["model", "instructions", "input", "messages", "tools", "tool_choice", "parallel_tool_calls", "stream", "temperature", "top_p", "max_tokens", "max_output_tokens", "reasoning", "reasoning_effort", "store"] as const;
