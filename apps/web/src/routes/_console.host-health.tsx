...
function HostHealth(){
 const view=Route.useLoaderData(),router=useRouter(),health=view.data,evidence=health?.latest,runtime=health?.runtime,receipt=runtime?.receipt;
 ...
 <dt>Handler attachment</dt><dd>not-observed</dd><dt>Exercised behavior</dt><dd>not-exercised</dd><dt>Overall qualification</dt><dd>Not established</dd></dl>
