...
test("production console browser qualification uses relocated artifacts and synthetic native facts", async () => {
  ...
  try {
    ...
    const result = spawnSync("node", ["--test", "--test-reporter=tap", entry], { cwd: directory, encoding: "utf8", timeout: 180_000,
