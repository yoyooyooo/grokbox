...
const NOT_PROVEN = {
  ...
  "pre-e2e-observation": ["native-host-live-adoption", "actual-provider-or-app-receipt", "os-boot-service-registration", "installation-wide-physical-reservations", "full-safe-ledger-retirement-and-backup-restore-fence", "external-business-tool-commit", "independent-review"],
