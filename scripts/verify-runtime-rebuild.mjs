...
const CASES = {
  ...
  "pre-e2e-observation": [
    ["bun", "run", "typecheck"], ["bun", "run", "build"],
    ["bun", "test", "packages/box-runtime/test/observation-producer-boundaries.test.ts", "packages/box-runtime/test/context-maintenance-boundaries.test.ts", "packages/box-runtime/test/monitor-service-lifetime.test.ts", "packages/box-runtime/test/daemon-socket-recovery.test.ts", "test/monitor-service-packed.test.ts", "test/incident-evidence-integration.test.ts"],
