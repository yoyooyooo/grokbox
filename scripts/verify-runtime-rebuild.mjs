...
const CASES = {
  ...
  "pre-e2e-observation": [
    ["bun", "run", "typecheck"], ["bun", "run", "build"],
    ["bun", "test", "packages/box-runtime/test/observation-producer-boundaries.test.ts", "packages/box-runtime/test/context-maintenance-boundaries.test.ts", "packages/box-runtime/test/monitor-service-lifetime.test.ts", "packages/box-runtime/test/daemon-socket-recovery.test.ts", "test/monitor-service-packed.test.ts", "test/incident-evidence-integration.test.ts", "packages/box-runtime/test/notification-restore-fence.test.ts"],
    ["bun", "test", "packages/box-runtime/test/monitor-scheduling-review.test.ts", "packages/box-runtime/test/monitor-commit-boundaries.test.ts", "packages/box-runtime/test/obs-continuity-contract.test.ts", "packages/box-runtime/test/ops-notification-outbox.test.ts", "packages/box-runtime/test/storage-maintenance-lifetime.test.ts", "packages/box-runtime/test/observation-storage-pressure.test.ts", "packages/box-runtime/test/observation-storage-soak.test.ts", "packages/box-runtime/test/diagnostic-admission.test.ts", "test/daemon.test.ts", "test/monitor-incident-cli.test.ts", "test/live-e2e-checklist.test.ts", "test/modeld-core-verifier.test.ts", "packages/box-runtime/test/context-continuity-artifact.test.ts"],
    ["bun", "test", "packages/box-runtime/test/execution-retirement.test.ts", "packages/box-runtime/test/execution-history-storage-review.test.ts", "packages/box-runtime/test/execution-history-node.test.ts", "packages/box-runtime/test/context-maintenance-lifetime.test.ts", "packages/box-runtime/test/routine-provision.test.ts", "packages/box-runtime/test/runtime-services-installation.test.ts", "packages/box-runtime/test/modeld-persistent-restart.test.ts", "test/runtime-services-packed.test.ts"],
    ["node", "scripts/check-runtime-boundaries.mjs"], ["node", "scripts/check-publication.mjs", "--include-untracked"],
  ],
  "automatic-notification": [
    ...
    ["bun", "test", "packages/box-runtime/test/ops-target-pairing.test.ts", "packages/box-runtime/test/obs-continuity-contract.test.ts", "test/daemon.test.ts", "test/modeld-core-verifier.test.ts", "packages/box-runtime/test/context-continuity-artifact.test.ts"],
    ["bun", "scripts/check-runtime-boundaries.mjs"], ["node", "scripts/check-publication.mjs", "--include-untracked"],
  ],
  "native-notification": [
    ["bun", "run", "typecheck"], ["bun", "run", "build"],
    ["bun", "test", "packages/box-runtime/test/ops-native-notification.test.ts", "test/ops-native-notification-cli.test.ts", "test/receiver-frame.test.ts", "packages/box-runtime/test/ops-notification-outbox.test.ts", "packages/box-runtime/test/ops-target-pairing.test.ts", "packages/box-runtime/test/obs-continuity-contract.test.ts"],
    ["bun", "test", "packages/box-runtime/test/context-continuity-artifact.test.ts", "test/skills.test.ts", "test/modeld-core-verifier.test.ts"],
    ["bun", "scripts/check-runtime-boundaries.mjs"], ["node", "scripts/check-publication.mjs", "--include-untracked"],
  ],
  "ops-receiver": [
    ["bun", "run", "typecheck"], ["bun", "run", "build"],
  ...
  "routine-provision": [
    ["bun", "run", "typecheck"], ["bun", "run", "build"],
    ["bun", "test", "packages/box-runtime/test/routine-provision.test.ts", "test/agent-routines-cli.test.ts", "packages/runtime-kernel/test/agent-routines.test.ts", "packages/box-runtime/test/obs-continuity-contract.test.ts", "test/daemon.test.ts", "test/skills.test.ts"],
    ["bun", "test", "packages/box-runtime/test/context-continuity-artifact.test.ts", "packages/box-runtime/test/journal-lock-recovery.test.ts", "packages/box-runtime/test/architecture.test.ts"],
    ["bun", "scripts/check-runtime-boundaries.mjs"],
    ["node", "scripts/check-publication.mjs", "--include-untracked"],
  ],
  "obs-continuity": [
...
const SUPPORTS = {
  ...
  "pre-e2e-observation": ["real-metadata-producer-tool-and-checkpoint-boundaries", "same-execution-artifact-tool-correlation", "source-owned-run-health-not-log-liveness", "canonical-collector-installation-no-start-on-read", "daemon-owned-dual-journal-drain", "owned-node-crash-restart-no-source-replay", "exact-socket-owner-recovery", "source-failure-to-fixed-evidence-and-single-notice", "context-observer-settles-before-close", "automatic-worker-start-cutoff", "in-lifetime-restored-db-no-duplicate-post", "expired-evidence-does-not-retire-replay-guards", "bounded-diagnostic-soak", "coordinated-diagnostic-writer-admission", "closed-turn-child-retirement-at-actual-admission", "settled-context-detail-retirement-no-replay", "exact-provision-tombstones-and-bounded-physical-store", "explicit-service-manager-registration-and-readback", "packed-modeld-exact-dead-socket-recovery"],
  ...
  "routine-provision": ["explicit-disabled-provision-with-scoped-ledger", "single-native-mutation-after-durable-reservation", "new-operation-cannot-bypass-unresolved-key", "explicit-exact-id-reconciliation", "real-child-death-recovery-no-replay", "bounded-guard-count-and-main-file", "corrupt-ledger-never-reinitialized", "local-daemon-and-packed-node-entrypoints", "j1-interfaces-unchanged"],
...
const REALITY = {
  ...
  "pre-e2e-observation": "production-programs-owned-native-boundaries-real-journals-sqlite-node-daemon-and-loopback-http-no-production-account-mutation",
  ...
  "routine-provision": "real-private-sqlite-owned-child-sigkill-synthetic-native-http-real-cli-daemon-packed-node-no-native-bot-effects",
...
const NOT_PROVEN = {
  ...
  "pre-e2e-observation": ["native-host-live-adoption", "actual-provider-or-app-receipt", "target-machine-boot-manager-availability-and-installation", "os-filesystem-quota-and-unmanaged-user-data", "arbitrary-whole-machine-rollback-without-external-monotonic-anchor", "infinite-lifetime-identity-forgetting", "external-business-tool-commit", "independent-review"],
  ...
  "routine-provision": ["native-http-create-update-qualification", "native-cas-idempotency-or-inflight-settlement", "credential-pairing-and-webhook-delivery", "multi-entry-routines-from-agent-creation", "replay-safe-ledger-retirement", "interrupted-first-ledger-init-recovery", "independent-review-and-live-schema4-cutover"],
